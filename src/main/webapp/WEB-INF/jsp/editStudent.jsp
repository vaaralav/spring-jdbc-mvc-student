...
<main id="root" class="container">
    ...
    <div class="content">
        <form id="edit-student" method="POST" action="/api/student/${student.id}">
            <label for="student-name">
                Name:
                <input id="student-name" name="name" type="text" value="${student.getName()}"/>
            </label>
            <label for="student-gpax">
                GPAX:
                <input id="student-gpax" name="gpax" type="number" value="${student.getGPAX()}"/>
            </label>
            <label for="student-ambition">
                Ambition:
                <input id="student-ambition" name="ambition" type="text" value="${student.getAmbition()}"/>
            </label>
